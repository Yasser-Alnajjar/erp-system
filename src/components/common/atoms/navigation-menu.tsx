...
const navigationMenuTriggerStyle = cva(
  "group inline-flex w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-[color,box-shadow] outline-none focus-visible:ring-[3px] focus-visible:outline-1 focus-visible:ring-input/50 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
...
const navigationMenuLinkVariants = cva(
  "mb-0.5 last:mb-0 text-nowrap relative flex flex-col gap-1 rounded-sm p-2 text-sm transition-all outline-none focus-visible:ring-[3px] focus-visible:outline-1 [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-muted-foreground focus-visible:ring-input/50",
  {
    variants: {
      variant: {
        default:
